 ...
 /*       sysMenu_add:function(args){
        ...
        sysMenu_add:function(args){
            var obj = new Object();
                obj.title = args.title ;
                obj.href = args.href ;
            $("#parentMenu").append("<li><a href='#' title='"+obj.title+"' id='"+obj.href+"' onclick=COMMON.func.sysTabButtonAdd(this)><p align=center><font size='5'>"+obj.title+"</font></p></a></li>"
            );
        },
        //系统菜单修改
    ...
    func:{
        ...
        sysTabButtonAdd: function (args) {
            $("#easytabs").tabs('add',{
                ...
                //href:$(args).attr("id"),
                content:"<iframe frameborder=0  id='"+$(args).attr("id")+"' src="+$(args).attr("id")+" width='100%' height='100%'></iframe>",
                closable:true
            });
        $("#easytabs").css("height","100%");
        $(".panel-body").css("height","500px");
        }
    },
    //菜单管理
...
$(function(){
   /* $('#win').window('close');*/
    ...
    $("#menu").addClass("menu--anim menu--open");
})
